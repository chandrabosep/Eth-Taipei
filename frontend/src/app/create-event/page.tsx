  ...
  return (
    <div className="min-h-screen bg-[#f8f5e6] p-8">
      <div className="max-w-2xl mx-auto bg-[#f0e6c0] rounded-xl shadow-lg p-6 border-2 border-[#b89d65]">
        <h1 className="text-3xl font-serif text-[#5a3e2b] mb-8">Create New Event</h1>
        
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Event Name Input */}
          <div>
            <label htmlFor="eventName" className="block text-[#5a3e2b] font-medium mb-2">
              Event Name
            </label>
            <input
              type="text"
          ...
          {/* Description Input */}
          <div>
            <label htmlFor="description" className="block text-[#5a3e2b] font-medium mb-2">
              Event Description
            </label>
            <textarea
              id="description"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="startDate" className="block text-[#5a3e2b] font-medium mb-2">
                Start Date & Time
              </label>
              <input
                type="datetime-local"
            ...
            <div>
              <label htmlFor="endDate" className="block text-[#5a3e2b] font-medium mb-2">
                End Date & Time
              </label>
              <input
                type="datetime-local"
